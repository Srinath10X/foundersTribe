...
export class ParticipantRepository {
    async addParticipant(roomId, userId, role, socketId) {
        ...
        if (error) {
            logger.error({ error, roomId, userId }, 'ParticipantRepository.addParticipant failed');
    ...
    async getConnectedParticipants(roomId) {
        ...
        if (error) {
            logger.error({ error, roomId }, 'ParticipantRepository.getConnectedParticipants failed');
    ...
    async countConnected(roomId) {
        ...
        if (error) {
            logger.error({ error, roomId }, 'ParticipantRepository.countConnected failed');
    ...
    async updateSocketId(roomId, userId, socketId) {
        ...
        if (error) {
            logger.error({ error, roomId, userId }, 'ParticipantRepository.updateSocketId failed');
    ...
    async markDisconnected(roomId, userId) {
        ...
        if (error) {
            logger.error({ error, roomId, userId }, 'ParticipantRepository.markDisconnected failed');
    ...
    async markDisconnectedBySocket(userId, roomId, socketId) {
        ...
        if (error) {
            logger.error({ error, roomId, userId, socketId }, 'ParticipantRepository.markDisconnectedBySocket failed');
            throw new Error('Database error marking disconnected');
        }
    }
    ...
    async getParticipantRooms(socketId) {
        ...
        if (error) {
            logger.error({ error, socketId }, 'ParticipantRepository.getParticipantRooms failed');
            return [];
        }
        return data || [];
    }
    ...
    async removeAllInRoom(roomId) {
        ...
        if (error) {
            logger.error({ error, roomId }, 'ParticipantRepository.removeAllInRoom failed');
    ...
    async deleteParticipant(roomId, userId) {
        ...
        if (error) {
            logger.error({ error, roomId, userId }, 'ParticipantRepository.deleteParticipant failed');
    ...
    async updateParticipant(roomId, userId, updates) {
        ...
        if (error) {
            logger.error({ error, roomId, userId, updates }, 'ParticipantRepository.updateParticipant failed');
