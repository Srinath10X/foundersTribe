...
function resolveConnectionString() {
    ...
    if (!password || !host) {
        throw new Error("Missing DATABASE_URL (or SUPABASE_DB_PASSWORD + SUPABASE_DB_HOST) in environment.");
    }
...
async function run() {
    ...
    `);
        console.log("Verified columns:", verify.rows.map((r) => r.column_name).join(", "));
