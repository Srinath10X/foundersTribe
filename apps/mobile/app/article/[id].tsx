...
export default function ArticleDetailScreen() {
  ...
  const fetchRelatedArticles = async () => {
    try {
      ...
      const excludeIds = [...historyIds, article.id].filter(
      ...
      if (finalArticles.length < 5) {
        ...
        let fallbackQuery = supabase.from("Articles").select("*").limit(20);
      ...
      >
        ...
        <View style={styles.heroContainer}>
          ...
          <View
            style={[
              styles.topControls,
              { top: (Platform.OS === "ios" ? 50 : 20) + insets.top },
            ]}
          >
          ...
          <View style={styles.articleHeader}>
            ...
            <View style={styles.metaRow}>
              <Text style={[styles.metaText, { color: theme.text.secondary }]}>
                {article["Company Name"] ? `${article["Company Name"]} • ` : ""}
                {readTime}
              </Text>
            </View>
          </View>
              ...
              >
                <Animated.View style={bookmarkAnimatedStyle}>
                  <MaterialIcons
                    ...
                    size={24}
                    color={bookmarked ? "#FFD700" : theme.text.secondary}
                  />
                </Animated.View>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.fontControls}>
              <TouchableOpacity onPress={decreaseFontSize} hitSlop={10}>
                <Text
                  style={[
                    styles.fontIcon,
                    { fontSize: 16, color: theme.text.secondary },
                  ]}
                >
                  A
                </Text>
              ...
              <TouchableOpacity onPress={increaseFontSize} hitSlop={10}>
                <Text
                  style={[
                    styles.fontIcon,
                    { fontSize: 22, color: theme.text.primary },
                  ]}
                >
                  A
                </Text>
